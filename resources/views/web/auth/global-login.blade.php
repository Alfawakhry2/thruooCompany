    ...
    <div class="col-lg-6">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form method="POST" action="{{ url('/auth/global-login') }}" class="mb-4">
                    @csrf
                    <div class="mb-3">
                ...
                @if (!empty($companies))
                    ...
                    <form method="POST" action="{{ url('/auth/login-with-company') }}">
                        @csrf
                ...
                <div class="text-center mt-3">
                    <a href="{{ url('/registration/register') }}">Create a new account</a>
                </div>
            </div>
        </div>
    </div>
